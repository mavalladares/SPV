...
<?php
echo anchor(base_url().'index.php/venta/add/','<span class="glyphicon glyphicon-plus"></span> Agregar',array('class'=>'btn btn-primary'));
echo '<h1> venta</h1>';
if(!$results){
...
for($i=0;$i<count($results);$i++){
            ...
            $results[$i]['Edit']     = '<div class="btn-group">'.anchor(base_url().'index.php/venta/edit/'.$id[0],'<span class="glyphicon glyphicon-pencil"></span>',
