...
<?php
echo anchor(base_url().'index.php/proveedor/add/','<span class="glyphicon glyphicon-plus"></span> Agregar',array('class'=>'btn btn-primary'));
...
for($i=0;$i<count($results);$i++){
            ...
            $results[$i]['Edit']     = '<div class="btn-group">'.anchor(base_url().'index.php/proveedor/edit/'.$id[0],'<span class="glyphicon glyphicon-pencil"></span>',
...
$(document).ready(function(){
    $('.toDelete').click(function(){
        $('a.borrar').attr('href',"<?=base_url()?>index.php/proveedor/delete/"+$(this).attr('id'));
    });
});
</script>
