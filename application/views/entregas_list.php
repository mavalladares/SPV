...
<?php
echo anchor(base_url().'index.php/entregas/add/','<span class="glyphicon glyphicon-plus"></span> Agregar',array('class'=>'btn btn-primary'));
echo '<h1> entregas</h1>';
if(!$results){
...
for($i=0;$i<count($results);$i++){
            ...
            $results[$i]['Edit']     = '<div class="btn-group">'.anchor(base_url().'index.php/entregas/edit/'.$id[0],'<span class="glyphicon glyphicon-pencil"></span>',
...
$(document).ready(function(){
    $('.toDelete').click(function(){
        $('a.borrar').attr('href',"<?=base_url()?>index.php/entregas/delete/"+$(this).attr('id'));
    });
});
</script>
