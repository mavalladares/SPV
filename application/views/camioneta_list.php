...
<aside class="right-side">
      ...
      <section class="content-header">
            <h1 class="text-info">
            Camionetas
            <small>Lista de camionetas</small>
            </h1>
      </section>
      <!-- Main content -->
...
<?php
echo anchor(base_url().'index.php/camioneta/add/','<span class="glyphicon glyphicon-plus"></span> Agregar',array('class'=>'btn btn-primary'));
echo '<h1> camioneta</h1>';
if(!$results){
...
for($i=0;$i<count($results);$i++){
            ...
            $results[$i]['Edit']     = '<div class="btn-group">'.anchor(base_url().'index.php/camioneta/edit/'.$id[0],'<span class="glyphicon glyphicon-pencil"></span>',
...
$(document).ready(function(){
    $('.toDelete').click(function(){
        $('a.borrar').attr('href',"<?=base_url()?>index.php/camioneta/delete/"+$(this).attr('id'));
    });
});
</script>
