...
for($i=0;$i<count($results);$i++){
            ...
            $results[$i]['Edit']     = '<div class="btn-group">'.anchor(base_url().'index.php/cliente/edit/'.$id[0],'<span class="glyphicon glyphicon-pencil"></span>',
...
$(document).ready(function(){
    $('.toDelete').click(function(){
        $('a.borrar').attr('href',"<?=base_url()?>index.php/cliente/delete/"+$(this).attr('id'));
    });
});
</script>
